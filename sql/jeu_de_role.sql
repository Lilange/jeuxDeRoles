...
--
-- Host: localhost
-- Generation Time: Feb 09, 2017 at 01:49 PM
...
ALTER TABLE `personnages`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `UNIQ_286738A696AA44DF` (`fk_stats`),
  ADD UNIQUE KEY `UNIQ_286738A656516591` (`fk_race`),
  ADD UNIQUE KEY `UNIQ_286738A6AF29D706` (`fk_classe`);
...
--
ALTER TABLE `personnages`
  ADD CONSTRAINT `FK_286738A656516591` FOREIGN KEY (`fk_race`) REFERENCES `race` (`id`),
  ADD CONSTRAINT `FK_286738A696AA44DF` FOREIGN KEY (`fk_stats`) REFERENCES `stats` (`id`),
  ADD CONSTRAINT `FK_286738A6AF29D706` FOREIGN KEY (`fk_classe`) REFERENCES `classe` (`id`);
